function crearLista() {
    ...
    '<li class="ui-block-b"><a href="#" data-role="button" onclick="crearLista()" data-icon="mail" class="ui-link ui-btn ui-icon-mail ui-btn-icon-top ui-shadow ui-corner-all" role="button" style="background-image:url(imgportada/cabecera.png)"><img src="" class="globo"  >Circulares</a></li>'+
